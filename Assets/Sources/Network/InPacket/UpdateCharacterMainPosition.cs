...
namespace Assets.Sources.Network.InPacket
{
    public sealed class UpdateCharacterMainPosition : NetworkBasePacket
    {
        ...
        public override PacketImplementCodeResult RunImpl()
        {
            ...
            try
            {
                _client.GetPlayers.FirstOrDefault(x => x.ObjId == _objId).
                    UpdatePositionInServer = new Vector3(_positionX, _positionY, _positionZ);
            }
            catch (Exception exception)
            {
                ...
                codeError.FireException = nameof(UpdateCharacterMainPosition);
            }
